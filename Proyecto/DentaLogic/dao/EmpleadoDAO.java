...
public class EmpleadoDAO {
    ...
    // Constructor por defecto (conecta automáticamente)
    public EmpleadoDAO() {
        this.conexion = ConexionBD.conectar();
    }

    // ✅ Constructor con conexión externa (usado en servlets)
    ...
    public boolean agregarEmpleado(Empleado emp) {
        String sql = "INSERT INTO empleados (emp_dni, emp_nom, emp_ape, emp_email, emp_tel, emp_fec, emp_sal, esp_id) " +
                     "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public boolean actualizarEmpleado(Empleado emp) {
        String sql = "UPDATE empleados SET emp_dni = ?, emp_nom = ?, emp_ape = ?, emp_email = ?, emp_tel = ?, emp_fec = ?, emp_sal = ?, esp_id = ? " +
                     "WHERE emp_id = ?";
